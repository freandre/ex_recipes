defmodule ExRecipesWeb.CommentControllerTest do
  use ExRecipesWeb.ConnCase

  alias ExRecipes.Recipes

  @create_attrs %{comment: "some comment", posted_at: ~N[2010-04-17 14:00:00.000000]}
  ...
  def fixture(:comment) do
    {:ok, comment} = Recipes.create_comment(@create_attrs)
    comment
  end
